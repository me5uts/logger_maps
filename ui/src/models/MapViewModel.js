 ...
 * @property {function(Track, boolean)} displayTrack
 ...
 * @property {function(Track, string, Object)} setTrackGradientStyle
...
export default class MapViewModel extends ViewModel {
  ...
  /**
   * @param {Track} track Track to display
   ...
   */
   getPopupElement(id) {
    ...
    let time = '–––';
    if (pos.timestamp > 0) {
      const dateTime = Utils.getTimeString(new Date(pos.timestamp * 1000));
      date = dateTime.date;
