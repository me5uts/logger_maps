...
export default class Observer {
    ...
    Object.defineProperty(obj, property, {
      ...
      set: (newValue) => {
        if (obj._values[property] !== newValue) {
          ...
          Observer.notify(obj._observers[property], newValue);
        }
        if (Array.isArray(obj[property])) {
    ...
    if (Array.isArray(obj)) {
      ...
      for (const prop in obj) {
        if (obj.hasOwnProperty(prop)) {
          Observer.observeProperty(obj, prop, observer);
        }
      }
    }
  }
  ...
  static unobserveRecursive(obj, observer) {
    for (const prop in obj) {
      if (obj.hasOwnProperty(prop)) {
        Observer.unobserveProperty(obj, prop, observer);
      }
    }
  }
      ...
      (operation) => {
        ...
        if (!arr.hasOwnProperty(operation)) {
          descriptor.value = function () {
            ...
            Observer.notify(arr._observers, arr);
            return result;
          };
